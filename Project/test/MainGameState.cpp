...
void MainGameState::Init()
{
	...
	m_staticObjectTexture = std::make_unique<Texture>();
	m_staticObjectTexture->Load("Assets/stone.png"); 

	m_playerObject = std::make_unique<GameObject>();
	m_playerObject->GetTransform().SetPosition({ 400.f, 360.f });
